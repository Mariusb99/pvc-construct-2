  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="mb-6 rounded-tags border border-silver-lining bg-mist-gray px-4 py-3 text-[13px] text-slate">
        Pasul 1 din 2: completează datele de bază și apasă „Creează utilaj&rdquo;. Imediat
        după salvare se deschide pagina utilajului, unde poți adăuga fotografiile și
